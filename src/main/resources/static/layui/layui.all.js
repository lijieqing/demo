...
!function (e, t) {
    ...
    var ve = function (e) {
        ...
        function v(e) {
            for (var t, n, r, i = e.length, o = T.relative[e[0].type], a = o || T.relative[" "], s = o ? 1 : 0, u = p(function (e) {
                ...
                if (n = com.fengmi.demo.servlet[e[s].type].apply(null, e[s].matches), n[P]) {
        ...
        w = t.support = {}, E = t.isXML = function (e) {
            ...
            }, com.fengmi.demo.servlet.ID = function (e) {
                var t = e.replace(be, we);
                return function (e) {
                    return e.getAttribute("id") === t
                }
            }) : (delete T.find.ID, com.fengmi.demo.servlet.ID = function (e) {
                var t = e.replace(be, we);
                return function (e) {
    ...
    pe.filter = function (e, t, n) {
        ...
        find: function (e) {
            ...
            if ("string" != typeof e) return this.pushStack(com.fengmi.demo.servlet(function () {
    ...
    pe.fn.extend({
        has: function (e) {
            ...
            return com.fengmi.demo.servlet(function () {
            ...
            return this.add(null == e ? this.prevObject : com.fengmi.demo.servlet(e))
        }
    }), pe.each({
        parent: function (e) {
            var t = e.parentNode;
    ...
    pe.event = {
        ...
        fix: function (e) {
            ...
            return e.target || (e.target = o.srcElement || re), 3 === e.target.nodeType && (e.target = e.target.parentNode), e.metaKey = !!e.metaKey, com.fengmi.demo.servlet ? com.fengmi.demo.servlet(e, o) : e
        },
    ...
    pe.extend({
        ...
        get: function (e, t) {
            return vt.test((t && e.currentStyle ? com.fengmi.demo.servlet : com.fengmi.demo.servlet) || "") ? .01 * parseFloat(RegExp.$1) + "" : t ? "1" : ""
        }, set: function (e, t) {
            var n = e.style, r = e.currentStyle, i = pe.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
                o = r && r.filter || n.filter || "";
            n.zoom = 1, (t >= 1 || "" === t) && "" === pe.trim(o.replace(yt, "")) && n.removeAttribute && (n.removeAttribute("servlet"), "" === t || r && !r.filter) || (n.filter = yt.test(o) ? o.replace(yt, i) : o + " " + i)
        }
    ...
    pe.Animation = pe.extend($, {
        ...
        fadeTo: function (e, t, n, r) {
            return com.fengmi.demo.servlet(Re).css("opacity", 0).show().end().animate({opacity: t}, e, n, r)
...
layui.define("jquery", function (t) {
    ...
    s.prototype.set = function (t) {
        ...
        var e = ".layui-tab-title", l = a(".layui-tab[lay-servlet=" + t + "]"), n = l.children(e),
        ...
        var e = "layui-progress", l = a("." + e + "[lay-servlet=" + t + "]"), n = l.find("." + e + "-bar"),
            s = n.find("." + e + "-text");
        ...
        y = "layui-nav-more", h = "layui-anim layui-anim-upbit", f = {
            tabClick: function (t, i, s, o) {
                ...
                var r = s || a(this), i = i || r.parent().children("li").index(r),
                    ...
                    d = r.find("a"), y = c.attr("lay-servlet");
                ...
                var n = i || a(this).parent(), s = n.index(), o = n.parents(".layui-tab").eq(0),
                    r = o.children(".layui-tab-content").children(".layui-tab-item"), c = o.attr("lay-servlet");
                ...
                var t = a(this), i = t.parents(o), n = i.attr("lay-servlet"), s = t.parent(), c = t.siblings("." + d),
                ...
                var t = a(this), i = t.find(".layui-colla-icon"), l = t.siblings(".layui-colla-content"),
                    s = t.parents(".layui-collapse").eq(0), o = s.attr("lay-servlet"), r = "none" === l.css("display");
        ...
        var n = this, u = t(r + function () {
            ...
            select: function () {
                    ...
                    f = u.find("select"), v = function (i, l) {
                        ...
                        if (!u) {
                            ...
                            f && k.on("keyup", q).on("blur", function (i) {
                                ...
                                var e = t(this), a = e.attr("lay-value"), n = p.attr("lay-servlet");
                ...
                var e = {
                    ...
                    var a = t(this);
                    e.on("click", function () {
                        var t = a.attr("lay-servlet"), n = (a.attr("lay-text") || "").split("|");
                ...
                var e = "layui-form-radio", i = ["&#xe643;", "&#xe63f;"], a = u.find("input[type=radio]"),
                    n = function (a) {
                        ...
                        a.on("click", function () {
                            var o = n[0].name, c = n.parents(r), u = n.attr("lay-servlet"),
...
layui.define("form", function (e) {
    ...
    g.prototype.config = {
        ...
        var e = this, a = e.config,
            n = i('<div class="layui-tree' + (a.showCheckbox ? " layui-form" : "") + (a.showLine ? " layui-tree-line" : "") + '" lay-servlet="LAY-tree-' + e.index + '"></div>');
        e.tree(n);
...
layui.define(["laytpl", "form"], function (e) {
    ...
    var a = layui.$, t = layui.laytpl, n = layui.form, i = "transfer", l = {
        ...
        y = "layui-transfer-data", p = function (e) {
            return e = e || {}, ['<div class="layui-transfer-box" data-index="' + e.index + '">', '<div class="layui-transfer-header">', '<input type="checkbox" name="' + e.checkAllName + '" lay-servlet="layTransferCheckbox" lay-type="all" lay-skin="primary" title="{{ d.data.title[' + e.index + "] || 'list" + (e.index + 1) + "' }}\">", "</div>", "{{# if(d.data.showSearch){ }}", '<div class="layui-transfer-search">', '<i class="layui-icon layui-icon-search"></i>', '<input type="input" class="layui-input" placeholder="关键词搜索">', "</div>", "{{# } }}", '<ul class="layui-transfer-data"></ul>', "</div>"].join("")
        }, v = ['<div class="layui-transfer layui-form layui-border-box" lay-servlet="LAY-transfer-{{ d.index }}">', p({
            index: 0,
    ...
    x.prototype.config = {
        ...
        e.parseData(function (e) {
            var t = e.selected ? 1 : 0,
                n = ["<li>", '<input type="checkbox" name="' + a[t].checkName + '" lay-skin="primary" lay-servlet="layTransferCheckbox" title="' + e.title + '"' + (e.disabled ? " disabled" : "") + (e.checked ? " checked" : "") + ' value="' + e.value + '">', "</li>"].join("");
        ...
        var e = this, t = e.config;
        e.elem.on("click", 'input[lay-servlet="layTransferCheckbox"]+', function () {
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form,
        ...
        W = "layui-table-edit", _ = "layui-table-hover", E = function (e) {
            ...
            }(), "{{# var isSort = !(item2.colGroup) && item2.sort; }}", '<th data-field="{{ item2.field||i2 }}" data-key="{{d.index}}-{{i1}}-{{i2}}" {{# if( item2.parentKey){ }}data-parentkey="{{ item2.parentKey }}"{{# } }} {{# if(item2.minWidth){ }}data-minwidth="{{item2.minWidth}}"{{# } }} ' + t + ' {{# if(item2.unresize || item2.colGroup){ }}data-unresize="true"{{# } }} class="{{# if(item2.hide){ }}layui-hide{{# } }}{{# if(isSort){ }} layui-unselect{{# } }}{{# if(!item2.field){ }} layui-table-col-special{{# } }}">', '<div class="layui-table-cell laytable-cell-', "{{# if(item2.colGroup){ }}", "group", "{{# } else { }}", "{{d.index}}-{{i1}}-{{i2}}", '{{# if(item2.type !== "normal"){ }}', " laytable-cell-{{ item2.type }}", "{{# } }}", "{{# } }}", '" {{#if(item2.align){}}align="{{item2.align}}"{{#}}}>', '{{# if(item2.type === "checkbox"){ }}', '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" lay-servlet="layTableAllChoose" {{# if(item2[d.data.checkName]){ }}checked{{# }; }}>', "{{# } else { }}", '<span>{{item2.title||""}}</span>', "{{# if(isSort){ }}", '<span class="layui-table-sort layui-inline"><i class="layui-edge layui-table-sort-asc" title="升序"></i><i class="layui-edge layui-table-sort-desc" title="降序"></i></span>', "{{# } }}", "{{# } }}", "</div>", "</th>", e.fixed ? "{{# }; }}" : "", "{{# }); }}", "</tr>", "{{# }); }}", "</thead>", "</table>"].join("")
        },
    ...
    I.prototype.config = {
        ...
        loading: !0,
        cellMinWidth: 60,
        defaultToolbar: ["servlet", "exports", "print"],
        autoSort: !0,
        text: {none: "无数据"}
        ...
        var n, r, c = this, s = {}, u = c.config, h = u.elem.attr("lay-servlet"), f = d.cache[c.key];
                    ...
                    s({
                        list: function () {
                            ...
                            return a.eachCols(function (t, i) {
                                i.field && "normal" == i.type && e.push('<li><input type="checkbox" name="' + i.field + '" data-key="' + i.key + '" data-parentkey="' + (i.parentKey || "") + '" lay-skin="primary" ' + (i.hide ? "" : "checked") + ' title="' + (i.title || i.field) + '" lay-servlet="LAY_TABLE_TOOL_COLS"></li>')
                            }), e.join("")
                        }(), done: function () {
        ...
        a.elem.on("click", 'input[name="layTableCheckbox"]+', function () {
            var e = t(this).prev(), i = a.layBody.find('input[name="layTableCheckbox"]'),
                ...
                o = "layTableAllChoose" === e.attr("lay-servlet");
        ...
        i = i || {};
        var a = this, l = t(e ? 'table[lay-servlet="' + e + '"]' : h + "[lay-data]"),
...
layui.define("jquery", function (e) {
    ...
    m.prototype.config = {
        ...
        var n = this, l = n.elemItem, u = n.config, c = u.index, m = u.elem.attr("lay-servlet");
...
layui.define(["layer", "form"], function (t) {
    ...
    var s = function (t, i, a) {
        ...
        var l = this, n = i.open({
            ...
            title: "超链接",
            skin: "layui-layer-msg",
            content: ['<ul class="layui-form" style="margin: 15px;">', '<li class="layui-form-item">', '<label class="layui-form-label" style="width: 60px;">URL</label>', '<div class="layui-input-block" style="margin-left: 90px">', '<input name="url" lay-verify="url" value="' + (t.href || "") + '" autofocus="true" autocomplete="off" class="layui-input">', "</div>", "</li>", '<li class="layui-form-item">', '<label class="layui-form-label" style="width: 60px;">打开方式</label>', '<div class="layui-input-block" style="margin-left: 90px">', '<input type="radio" name="target" value="_self" class="layui-input" title="当前窗口"' + ("_self" !== t.target && t.target ? "" : "checked") + ">", '<input type="radio" name="target" value="_blank" class="layui-input" title="新窗口" ' + ("_blank" === t.target ? "checked" : "") + ">", "</div>", "</li>", '<li class="layui-form-item" style="text-align: center;">', '<button type="button" lay-submit lay-servlet="layedit-link-yes" class="layui-btn"> 确定 </button>', '<button style="margin-left: 20px;" type="button" class="layui-btn layui-btn-primary"> 取消 </button>', "</li>", "</ul>"].join(""),
        ...
        var e = this, l = i.open({
            ...
            title: "插入代码",
            skin: "layui-layer-msg",
            content: ['<ul class="layui-form layui-form-pane" style="margin: 15px;">', '<li class="layui-form-item">', '<label class="layui-form-label">请选择语言</label>', '<div class="layui-input-block">', '<select name="lang">', '<option value="JavaScript">JavaScript</option>', '<option value="HTML">HTML</option>', '<option value="CSS">CSS</option>', '<option value="Java">Java</option>', '<option value="PHP">PHP</option>', '<option value="C#">C#</option>', '<option value="Python">Python</option>', '<option value="Ruby">Ruby</option>', '<option value="Go">Go</option>', "</select>", "</div>", "</li>", '<li class="layui-form-item layui-form-text">', '<label class="layui-form-label">代码</label>', '<div class="layui-input-block">', '<textarea name="code" lay-verify="required" autofocus="true" class="layui-textarea" style="height: 200px;"></textarea>', "</div>", "</li>", '<li class="layui-form-item" style="text-align: center;">', '<button type="button" lay-submit lay-servlet="layedit-code-yes" class="layui-btn"> 确定 </button>', '<button style="margin-left: 20px;" type="button" class="layui-btn layui-btn-primary"> 取消 </button>', "</li>", "</ul>"].join(""),
